...
#install llvm
RUN curl https://github.com/llvm/llvm-project/releases/download/llvmorg-11.0.0/llvm-project-11.0.0.tar.xz -o $HOME/llvm.tar.gz && \
    tar xf $HOME/llvm.tar.gz -C $HOME && \
